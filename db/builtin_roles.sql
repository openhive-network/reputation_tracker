...
CREATE ROLE reptracker_app_owner WITH LOGIN INHERIT IN ROLE haf_app_admin;
...
GRANT CREATE ON DATABASE haf_block_log TO reptracker_app_owner;

GRANT reputation_tracker_writer_group TO reptracker_app_owner;
